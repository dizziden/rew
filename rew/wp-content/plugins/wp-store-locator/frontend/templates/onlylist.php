...
$output .= "\t\t\t\t" . '<div class="wpsl-search-from-title"><label>Search for locations</label></div>' . "\r\n";
...
$output .= "\t\t\t\t" . '<div class="wpsl-search-btn-wrap"><button id="wpsl-search-btn" type="submit" value="' . esc_attr( $wpsl->i18n->get_translation( 'search_btn_label', __( 'Search', 'wpsl' ) ) ) . '"><i class="fa fa-search"></i></button></div>' . "\r\n";
...
$output .= "\t\t\t" . '<ul class="panel-group" id="accordion"></ul>' . "\r\n";
$output .= "\t\t" . '</div>' . "\r\n";
